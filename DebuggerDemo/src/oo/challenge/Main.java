...
public class Main {
	...
	public static void main(String[] args) {
		...
		// the final price (base
		// burger with all the additions).
		// This burger has a base price and the additions are all seperately priced (up
		// to 4 additions, see above).
		// Create a Hamburger class to deal with all the above.
		// The constructor should only include the roll type, meat and price, can also
		// include name of burger or you can use setter.
		...
		// since the 2 additions are only appropriate for this new class (in other words
		// new burger type).
