...
public class SetChallenge {
	...
	public static void main(String[] args) {
		 ...
		 * has a "bodyType" field. This field will store the type of HeavenlyBody (such
		 * as STAR, PLANET, MOON, etc).
		 * 
		 * You can include as many types as you want, but must support at least PLANET
		 * and MOON.
		 * 
		 * For each of the types that you support, subclass the HeavenlyBody class so
		 * that your program can create objects of the appropriate type.
		 * 
		 ...
		 * so you could have a star called "BetaMinor" and an asteroid also called
		 * "BetaMinor", for example.
		 * 
		 ...
		 * moons. Even if you don't implement a STAR type, though, your program should
		 * not prevent one being added in the future (and a STAR's satellites can be
		 * almost every kind of HeavenlyBody).
		 * 
		 * Test cases: 1. The planets and moons that we added in the previous video
		 * should appear in the solarSystem collection and in the sets of moons for the
		 * appropriate planets.
		 * 
		 ...
		 * the same map, and can be retrieved from the map.
		 */
	}
